...
export function AchievementsStrip() {
  ...
  return (
    <Card tone="gold" className="p-4 sm:p-5">
      <div className="flex items-center justify-between gap-2">
        <p className="font-display text-sm sm:text-base font-bold text-ink">Achievements</p>
      ...
      {nextUp ? (
        <div className="mt-3 sm:mt-4">
          <div className="flex items-center justify-between gap-2">
            <p className="flex min-w-0 items-center gap-2 text-sm font-semibold text-ink">
              <LockIcon size={13} className="shrink-0 text-ink-soft" />
        ...
        <p className="mt-2 sm:mt-3 text-sm font-medium text-ink-soft">Every badge earned. Impressive.</p>
      )}

      <Link
        href="/achievements"
        className="mt-3 sm:mt-4 inline-flex items-center gap-1 text-xs font-bold text-brand-2 transition-colors hover:text-brand focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand"
      >
        See all
